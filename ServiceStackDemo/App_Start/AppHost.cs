...
[assembly: WebActivator.PreApplicationStartMethod(typeof(ServiceStackDemo.App_Start.AppHost), "Start")]
...
namespace ServiceStackDemo.App_Start
{
	...
	{		
		public AppHost() //Tell ServiceStack the name and where to find your web services
			: base("Web Services at Ludicrous Speed Demo", typeof(HelloService).Assembly) { }
